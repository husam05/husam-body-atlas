...
const medicalText=medical.slice(0,inventoryStart),medicalInventory=medical.slice(inventoryStart).replace('**Public source inventory.**','## Medical sources\n\n').replace('All sources below were opened and relevant text retrieved on **11 September 2026**. They provide general explanation and terminology; local R1–R3 remain the sources for patient-specific claims. No search-result snippets are used as sole evidence.','The following institutional sources support general explanation and terminology. Local R1–R3 remain the sources for patient-specific claims. Accessed 11 September 2026.');

...
const css=[await readFile('src/style.css','utf8'),await readFile('src/modern.css','utf8'),await readOptional('src/anatomy-search.css'),await readOptional('src/report-library.css'),await readOptional('src/atlas-reports.css')].join('\n');
